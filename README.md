# AI QUARTET — Compare the intelligence of four leading AI models—Instantly.

A full-stack web application that allows users to ask any question and instantly compare real-time responses from 4(four) powerful AI models side-by-side, helping you evaluate creativity, accuracy, and reasoning across LLMs. (OpenAI, Google Gemini 2.0 Flash, DeepSeek, and Groq) in real-time, side-by-side.

**Stack**: React 19 + Vite 7.2 (frontend) | Express 5.1 + Node.js (backend) | Tailwind CSS 3.4 | Axios for API calls.

**Features**: Real-time Multi-Model Comparison, Serverless API Backend, Modern Neon UI, Independent Loading Indicators, Secure Environment Variables, One-Click Copy Response, Fully Responsive Design, Vite + React Frontend, Global Vercel Deployment and robust API error handling.
